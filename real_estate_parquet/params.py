...
RAW_DATASET_OUTPUT_FILE = os.path.join(RAW_DATASET_FOLDER, "raw_dataset_full", "transactions.parquet")

CLEANED_DATASET_FILE = os.path.join(CLEANED_DATASET_FOLDER, "cleaned_transactions_df.parquet")
MERGED_DATASET_FILE = os.path.join(MERGED_DATASET_FOLDER, "merged_dataset.parquet")

X_TRAIN = os.path.join(MERGED_DATASET_FOLDER,"train_set", "X_train.parquet")
Y_TRAIN = os.path.join(MERGED_DATASET_FOLDER,"train_set", "y_train.parquet")
X_TEST = os.path.join(MERGED_DATASET_FOLDER, "test_set", "X_test.parquet")
Y_TEST = os.path.join(MERGED_DATASET_FOLDER, "test_set", "y_test.parquet")

X_TRAIN_PREPROC = os.path.join(PREPROCESSED_DATASET_FOLDER, "X_train_preprocessed.parquet")
X_TEST_PREPROC = os.path.join(PREPROCESSED_DATASET_FOLDER, "X_test_preprocessed.parquet")


##################  ARTIFACTS & TRAINING PARAMS PATH   #####################
PREPROCESSOR_PATH = os.path.join(LOCAL_REGISTRY_PATH, "preprocessor","preprocessor.pkl")
CITY_MAPPING_PATH = os.path.join(LOCAL_REGISTRY_PATH, "city_mapping.parquet")
